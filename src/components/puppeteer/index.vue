...
export default {
  ...
  data() {
    return {
      searchContent: "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe",
      page: {},
    };
  },
  methods: {
    ...
    async withdraw(page) {
      ...
      // 點擊資金
      await page.click('#ae-layout > div.aside-menu > div > ul > li:nth-child(8) > div')
      await page.waitFor(3000);
      // 點擊資金中心
      await page.click('#ae-layout > div.aside-menu > div > ul > li:nth-child(8) > ul > li:nth-child(1)')
